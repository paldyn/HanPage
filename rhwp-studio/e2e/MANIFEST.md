...
| `hwp-password-open.test.mjs` | 상시 | active | #3474 HWP5 EncryptVersion 4 암호 문서: 대화상자·오답·취소·Enter·저장소 비보존 | hwp3-sample16-hwp5-2024-password.hwp | npm e2e:hwp-password-open | 실제 암호 fixture; 비밀번호와 로컬 E2E 보고서는 비커밋 |
