...
| #1599 / #1606 | 표 셀 중심선 렌더링 누락 수정 | merge 대기 | HWP5/HWPX 중심선 파싱·저장·렌더링 보강. `cargo test --lib` 및 WASM 빌드 통과. Stage 2 출력 시각 검증 완료. PR #1606 코드 head 원격 CI green 확인 후 review 문서 동반. |
