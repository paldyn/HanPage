...
- **완료일**: 2026-08-02
- **상태**: 로컬 PR 준비 완료, 원격 push·PR 승인 대기
...
고정한 뒤 원격 push와 `devel` 대상 PR 생성은 작업지시자 별도 승인 전까지 수행하지 않는다. #3695
통합 뒤에는 #3744를 진행하고, 두 이슈가 모두 `devel`에 포함된 뒤 #1528 최종 통합 검증으로 넘어간다.
