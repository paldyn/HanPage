...
| baseline manifest (보완 2) | `mydocs/tech/investigations/issue-1904/task_m100_1904_baseline_manifest.md` — 기준 commit `00014ecf`, 환경(rustc 1.93.1/rsvg 2.58/poppler 24.02/WSL2/OFL 폰트), 자산·명령·임계값·제외 목록 |
