...
- 작성일: 2026-07-10
- 상태: maintainer 조건부 승인 / 경미 수정 로컬 반영 완료 / CI 재검증 대기
...
| draft PR | #2174 조건부 승인. 수정 CI 통과 후 사용자 승인받아 ready 전환 |
...
#2124는 local implementation과 maintainer 요청 반영을 마쳤고 수정 CI와 merge를 기다리는 상태다.
