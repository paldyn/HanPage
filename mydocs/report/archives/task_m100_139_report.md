...
| 단계 | 산출물 | 위치 |
|------|--------|------|
| 1단계 | LaTeX vs 한컴 수식 비교 분석 | `mydocs/tech/investigations/issue-139/equation_latex_comparison.md` |
| 2~3단계 | 수식 폰트 조사·선정 및 적용 방안 | `mydocs/tech/investigations/issue-139/equation_font_selection.md` |
| 4단계 | 수식 레이아웃 정밀화 방안 | `mydocs/tech/investigations/issue-139/equation_layout_spec.md` |
