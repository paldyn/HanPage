...
| 항목 | 보존 경로 |
|------|-----------|
| 금감원 보도자료 HWP/HWPX | `samples/issue2020/fsc_20250813.hwp`, `samples/issue2020/fsc_20250813.hwpx` |
...
- 기존 `http://localhost:7700/` Vite 서버에서 `samples/issue2020/fsc_20250813.hwp` 로드 확인: 5쪽,
  Canvas 793x1122, 브라우저 console/page error 0건.

## 시각 검증

`mydocs/manual/visual_sweep_guide.md` 기준으로 대표 페이지를 확인했다.

| 항목 | 기준 PDF | 결과 | 대표 asset |
|------|----------|------|------------|
| FSC HWP 1쪽 | `pdf/issue2020/fsc_20250813_hwp-2022.pdf` | 5/5쪽, 플래그 0, pixel match 88.93448%, proxy 9.38671% | 참고: 임시 `output/issue2020/visual_fsc_hwp_p1_latest/.../review/review_001.png` |
| FSC HWP 2쪽 | `pdf/issue2020/fsc_20250813_hwp-2022.pdf` | 5/5쪽, `render_tree_frame_tail_overflow` 1건. 후보는 페이지 번호 `-2-`. 핵심 표는 2쪽 유지 | `mydocs/pr/assets/pr_2036_issue2020_fsc_hwp_review_p002.png` |
| FSC HWPX 1쪽 | `pdf/issue2020/fsc_20250813_hwpx-2022.pdf` | 5/5쪽, 플래그 0, pixel match 88.93448%, proxy 9.38671% | 참고: 임시 `output/issue2020/visual_fsc_hwpx_p1_latest/.../review/review_001.png` |
