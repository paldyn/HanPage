...
kind: pr-review
status: active
canonical: mydocs/pr/archives/pr_3730_review.md
last_verified: 2026-08-02
---

# PR #3730 검토 — MCP resources로 계약과 지식 지도를 제공
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#3730](https://github.com/edwardkim/rhwp/pull/3730) / @kevin9327 |
| 원 base / head | <code>devel</code> / <code>pr/mcp-resources-surface</code> <code>4fc53e5c50cab4db677f87e12ffac74404a7c7d2</code> |
| 누적 반영 | <code>d5272294d33bb73c3c129cf3a3bf8a73dcb1287c</code> |
| 통합 후보 | [#3742](https://github.com/edwardkim/rhwp/pull/3742) |

## 범위와 처분

#3627의 <code>mcp-serve</code> resource 표면을 추가해 계약, agent knowledge map,
실패 사전을 MCP 프로토콜 한 홉으로 제공한다. resource URI와 서버 contract 회귀를
포함하며 누적 코드에서 **수용 후보**다.
