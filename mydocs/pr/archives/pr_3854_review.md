# PR #3854 검토 기록 — webpack-cli 7.2.1 → 7.2.2

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3854](https://github.com/edwardkim/rhwp/pull/3854) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | VS Code development |
| source commit | `4e7df7c7edfb324c9c81a72daa3522e7223b09c4` |
| integration commit | `9a045c1e6` |
...
- Webpack 5.109.2와 동일 resolver 결과로 수용했다.
