# PR #3856 검토 기록 — actions/upload-artifact v4 → v7

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3856](https://github.com/edwardkim/rhwp/pull/3856) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | GitHub Actions |
| source commit | `53c0fb9ea14eaa33927a7f3bb93091688aa1dde3` |
| integration commit | `32d044bed` |
...
- wheel artifact name/path input이 v7과 호환된다.
