# PR #3850 검토 기록 — actions/setup-python v5 → v7

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3850](https://github.com/edwardkim/rhwp/pull/3850) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | GitHub Actions |
| source commit | `985456f4538751199c7b370e9e656e8727da7c39` |
| integration commit | `6500a07c9` |
...
- python-version input만 사용하는 workflow가 v7과 호환된다.
