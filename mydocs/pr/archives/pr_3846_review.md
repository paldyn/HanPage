# PR #3846 검토 기록 — roxmltree 0.20.0 → 0.21.1

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3846](https://github.com/edwardkim/rhwp/pull/3846) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | Rust XML parser |
| source commit | `c92946e5ae7dcce9ba59c862c4bddeb8237d0a16` |
| integration commit | `853d14195` |
...
- XML parser의 public document contract 변경은 없다.
