# PR #3852 검토 기록 — aes 0.8.4 → 0.9.2

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3852](https://github.com/edwardkim/rhwp/pull/3852) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | RustCrypto production |
| source commit | `05503eccb13231d5e8993a024688c6953ebf92de` |
| integration commit | `b560929e6` |
...
- aes 0.8.4 → 0.9.2.
- 새 generic block trait 이행과 HWP5/HWPX fixture를 확인했다.
