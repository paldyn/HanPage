...
5. PR 생성 뒤 본 review 문서를 archive 경로에 포함한다.
...
1. PR #2166의 최신 CI/CodeQL/Render Diff 완료를 대기한다.
2. 통과 뒤 작업지시자 merge 승인에 따라 admin merge한다.
3. merge 뒤 #2164 close 여부, `upstream/devel` 동기화, 원격/로컬 작업 브랜치 정리를 확인한다.
