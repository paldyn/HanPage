# PR #3851 검토 기록 — Vite 8.1.5 → 8.2.0 (rhwp-chrome)

## PR metadata

| 항목 | 내용 |
|---|---|
| 원 PR | [#3851](https://github.com/edwardkim/rhwp/pull/3851) |
| 작성자 / base | `dependabot[bot]` / `devel` |
| 변경 분류 | Chrome extension development |
| source commit | `dd139e8ba8c7ae0473b4c8890ae2f612967948c9` |
| integration commit | `ca11987c1` |
