...
**Why:** 문서 폴더 규칙 — canonical은 mydocs/manual/codex/docs_and_git_workflow.md Folder Roles (2026-07-17 CLAUDE.md 부트로더화 이후). `working/`은 단계별 보고서 전용이고 `report/`는 최종 보고서 전용이다. #62r 타스크에서 최종 보고서를 `working/`에 생성하는 실수 발생.
