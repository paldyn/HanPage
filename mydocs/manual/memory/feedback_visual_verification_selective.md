...
확인이 필요하면 `mydocs/manual/verification/visual_sweep_guide.md` 가 기본 진입점.
...
**How to apply** (거버넌스 문서 `mydocs/manual/verification/visual_verification_governance.md` 준수):
