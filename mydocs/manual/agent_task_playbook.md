...
## 커버리지 로드맵 — 아직 사람이 하는 일 (제안, #3370)

"대체되는 사람 업무 크기" 기준 우선순위 (편집 축 #2659 §7.3 연계):

| 사람 업무 | 필요한 축 | 상태 |
|---|---|---|
| 서식 값 채우기 | `edit fill-fields` | PR #3345 |
| 공문 문구 일괄 치환 | `edit replace-text` | 제안 |
| 보고서 표 수치 갱신 | `edit set-cell` | 제안 |
| 대량 메일머지 | `batch fill-fields` | 제안 (#3346 배치 골격 위) |
| 문단 추가/삭제·부분 편집 | edit 확장 | 로드맵 논의 |

새 축이 붙을 때마다 본 예제집에 "업무 → 시퀀스 → 기계 검증" 항목을 함께 추가하는 것을
