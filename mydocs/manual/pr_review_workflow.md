...
### 9.3.1 리뷰 문서 전용 후속 커밋 fast-pass

collaborator 가 외부 PR head 에 review 문서만 추가한 경우, 다음 조건을 모두 만족하면 heavy CI 가
job-level 로 skip 될 수 있다.
...
- PR head 최신 커밋 기준 GitHub Actions 통과 또는 review 문서 전용 후속 커밋 fast-pass 결과 확인
